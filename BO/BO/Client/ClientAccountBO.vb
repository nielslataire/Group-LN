...
Public Class ClientAccountBO
    ...
    Public Property Postalcode() As PostalCodeBO
        ...
        End Set
    End Property
    Private m_datesalesagreement As Date?
    <UIHint("Date")>
    <DisplayFormat(ApplyFormatInEditMode:=True, DataFormatString:="{0:dd/MM/yyyy}")>
    <DataType(DataType.Date)>
    <Display(Name:="Verkoopdatum")>
    Public Property DateSalesAgreement() As Date?
        Get
        ...
        End Set
    End Property
    Private m_datedeedofsale As Date?
    <UIHint("Date")>
    <DisplayFormat(ApplyFormatInEditMode:=True, DataFormatString:="{0:dd/MM/yyyy}")>
    <Display(Name:="Aktedatum")>
    Public Property DateDeedOfSale() As Date?
        Get
        ...
        End Set
    End Property
    Private m_datedeedofsaleexpdate As Date?
    <UIHint("Date")>
    <DisplayFormat(ApplyFormatInEditMode:=True, DataFormatString:="{0:dd/MM/yyyy}")>
    <Display(Name:="Uiterste aktedatum")>
    Public Property DateDeedOfSaleExpDate() As Date?
        Get
    ...
    Private _startdateconstruction As Date?
    <UIHint("Date")>
    <DisplayFormat(ApplyFormatInEditMode:=True, DataFormatString:="{0:dd/MM/yyyy}")>
    <DataType(DataType.Date)>
    <Display(Name:="Aanvangsdatum")>
    Public Property StartDateConstruction() As Date?
        Get
