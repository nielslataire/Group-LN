...
Public Class AccountController
    ...
    '    If (ModelState.IsValid AndAlso WebSecurity.Login(model.Login, model.Password, model.RememberMe)) Then
    ...
    '    'Dim result = Await SignInManager.PasswordSignInAsync(model.Login, model.Password, model.RememberMe, shouldLockout:=False)
    '    'Select Case result
