@modeltype AddGiftToClientModel

<script src="~/scripts/autoNumeric/autoNumeric.js"></script>

    @Using Html.BeginForm("AddUpdateGift", "Klanten", FormMethod.Post, New With {.id = "FormAddGift", .class = "form-horizontal mb-lg"})

    @<text>  
        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title">Toegift toevoegen</h2>
            </header>
            <div class="panel-body">
            @Html.Partial("_ValidationSummary", ViewData.ModelState)
            @Html.HiddenFor(Function(m) m.Gift.AccountId)
                @Html.HiddenFor(Function(m) m.ProjectId)
                @Html.HiddenFor(Function(m) m.Gift.Id)
                <div Class="form-group">
                    <div Class="col-md-12">
                        ...
                        <div class="col-md-10">
                            @Html.TextAreaFor(Function(m) m.Gift.Description, New With {.class = "form-control populate"})
