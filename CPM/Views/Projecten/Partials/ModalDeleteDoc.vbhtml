...
<div class="panel-body">
    <div class="modal-wrapper">
        ...
        <div class="modal-text">
            ...
            <p>U staat op het punt om het document @Model.Name te verwijderen.</p>
...
<footer class="panel-footer">
    <div class="row">
        <div class="col-md-12 text-right">
            <a href="@Url.Action("DeleteDoc", "Projecten", New With {.id = Model.Docid})" class="btn btn-warning btn-block">Verwijderen</a>
