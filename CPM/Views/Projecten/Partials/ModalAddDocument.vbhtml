...
<div id="modaladddoc" class="modal-block modal-block-primary mfp-hide">
    @Using Html.BeginForm("AddDocument", "Projecten", FormMethod.Post, New With {.id = "FormAddDoc", .class = "form-horizontal mb-lg", .enctype = "multipart/form-data"})
    @Html.AntiForgeryToken()
    @<text>
        @Html.HiddenFor(Function(m) m.ProjectId, New With {.id = "Docprojectid"})
        @Html.HiddenFor(Function(m) m.ClientAccountId, New With {.id = "Docclientaccountid"})
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                       @Html.EnumDropDownListFor(Function(m) m.Type, New With {.class = "form-control", .id = "DocType"})
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label" for="txtCaption">@Html.LabelFor(Function(m) m.Name)</label>
                    <div class="col-md-9">
                        @Html.TextBoxFor(Function(m) m.Name, New With {.placeholder = "Omschrijving", .class = "form-control", .id = "DoctxtCaption"})
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                            ...
                            <span class="input-group-addon btn btn-default btn-file"><span class="fileinput-new">Selecteren</span><span class="fileinput-exists">Wijzigen</span><input type="file" name="file" id="docfile"></span>
