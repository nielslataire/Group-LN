...
description: "Audit UI code against Vercel's Web Interface Guidelines: 100+ concrete rules for accessibility, focus, forms, animation, typography, performance, touch, dark mode, and i18n."
argument-hint: "<file-or-pattern>"
---

# Web Interface Guidelines

> Source: [vercel-labs/web-interface-guidelines](https://github.com/vercel-labs/web-interface-guidelines) — imported for local use in this project.

Review the target file(s) for compliance. Read the files, check against the rules below. Output concise but comprehensive — sacrifice grammar for brevity, high signal-to-noise.

Rules use MUST / SHOULD / NEVER to indicate severity.
