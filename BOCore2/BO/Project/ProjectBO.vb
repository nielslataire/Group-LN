...
Public Class ProjectBO
    ...
    Private _deliverydatedef As Date?
    <UIHint("Date")>
    <DisplayFormat(ApplyFormatInEditMode:=True, DataFormatString:="{0:dd/MM/yyyy}")>
    <DataType(DataType.Date)>
    <Display(Name:="Definitieve opleveringsdatum")>
    Public Property DeliveryDateDef() As Date?
        Get
    ...
    Public Property EpbReporter() As IdNameBO
        ...
        End Set
    End Property
    Private _facebookalbumid As String
    Public Property FacebookAlbumId() As String
        Get
    ...
    Public Property AspNetUserID() As String
        ...
        End Set
    End Property
    Private _totallandshare As Integer
    <Display(Name:="Totale grondaandelen")>
    Public Property TotalLandShare() As Integer
        Get
