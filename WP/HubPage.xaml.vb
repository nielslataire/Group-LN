...
Public NotInheritable Class HubPage
    ...
    Private Async Sub NavigationHelper_LoadState(sender As Object, e As LoadStateEventArgs) Handles _navigationHelper.LoadState
        ...
        'Dim DataContacts As IEnumerable(Of Contact) = Await DataSource.GetContactsAsync()
        'DefaultViewModel("Contacts") = DataContacts
        'For Each section As HubSection In Hub.Sections
        'If section.Name = "Hubsection4" Then
        'section.DataContext = DataContacts
        'End If
        'Next
    ...
    Private Sub GroupSection_ItemClick(sender As Object, e As ItemClickEventArgs)
        ...
        If groupId = "Group-1" Then
            If Not Frame.Navigate(GetType(ContactsPage), groupId) Then
