...
<div class="contact-modal-header contact-modal-header-success">
    ...
    <h3 class="contact-modal-title">Document verstuurd</h3>
    <div class="contact-modal-deco"></div>
    <p class="contact-modal-subtitle">Het gevraagde document is onderweg naar uw mailbox.</p>
</div>

<div class="contact-modal-body contact-modal-body-centered">
    <p class="contact-result-message">
        Het gevraagde document is per mail naar u verstuurd.<br />
