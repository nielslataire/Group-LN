...
Public Class ChangeOrderBO
    ...
    Private _changeorderdate As DateOnly
    <Required(ErrorMessage:="Gelieve een datum in te geven")>
    <DisplayFormat(ApplyFormatInEditMode:=True, DataFormatString:="{0:dd/MM/yyyy}")>
    <DataType(DataType.Date)>
    <Display(Name:="Datum")>
    <UIHint("Date")>
    Public Property ChangeOrderDate() As DateOnly
        Get
    ...
    Private _expirationdate As DateOnly
    ...
    Public Property Comment() As String
        ...
        End Set
    End Property
    Private _datesendtoclient As DateOnly?
    <DisplayFormat(ApplyFormatInEditMode:=True, DataFormatString:="{0:dd/MM/yyyy}")>
    <DataType(DataType.Date)>
    <Display(Name:="Datum verzonden")>
    <UIHint("Date")>
    Public Property DateSendToClient() As DateOnly?
        Get
    ...
    Private _dateagreement As DateOnly?
    <DisplayFormat(ApplyFormatInEditMode:=True, DataFormatString:="{0:dd/MM/yyyy}")>
    <DataType(DataType.Date)>
    <Display(Name:="Datum akkoord")>
    <UIHint("Date")>
    Public Property DateAgreement() As DateOnly?
        Get
