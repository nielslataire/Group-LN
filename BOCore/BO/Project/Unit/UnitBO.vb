...
Public Class UnitBO
    ...
    Private _landshare As Decimal?
    <Display(Name:="Verdeeleenheid basisakte")>
    Public Property Landshare() As Decimal?
        Get
            Return _landshare
        End Get
    ...
    Public ReadOnly Property TotalValue() As Decimal
        Get
            If Not LandValue Is Nothing AndAlso Not ConstructionValues Is Nothing Then
    ...
    Public ReadOnly Property TotalConstructionValues() As Decimal
        Get
            If Not ConstructionValues Is Nothing Then
