...
Public Class ClientPoaTranslator
    ...
    Friend Shared Function TranslateEntityToBO(_entity As ClientPOA, bo As ClientPoaBO) As ErrorCode
    ...
    End Function
    Friend Shared Function TranslateBOToEntity(_entity As ClientPOA, bo As ClientPoaBO, uow As UnitOfWork) As ErrorCode
        If _entity Is Nothing Then Return ErrorCode.EntityNull
        If bo Is Nothing Then Return ErrorCode.BoNull
    ...
    Private Shared Function HandleActivities(_entity As ClientPOA, activities As List(Of ActivityBO), uow As UnitOfWork) As ErrorCode
